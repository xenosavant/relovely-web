...
export const environment = {
  ...
  instagramSigninRedirectUrl: 'https://dev.relovely.com/account/instagram?type=signin',
  instagramLinkRedirectUrl: 'https://dev.relovely.com/account/instagram?type=link',
